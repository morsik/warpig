...
static void CG_DrawCrosshair(void)
{
	...
	// morsik: OH WAIT! We want shoot while leaning!
	/*	if(cg.snap->ps.leanf)
		{
			return;
		}*/
...
{
	// text on bottom when you are spectator
	//if (cg_specHelp.)
//		CG_DrawBigString(320 - 9 * 8, 440, CG_TranslateString(va("Watching %s", PLAYERNAME)), 1.f);
