...
extern void     BotVoiceChatAfterTeamIdleTime(int client, const char *id, int mode, int delay, qboolean voiceonly, int idleTime,
        qboolean forceIfDead);
extern void     AI_Team_Init_All_Teams();
extern void     AI_Team_Init(AI_Team_t *thisOne);
extern void     BotVoiceChatAfterIdleTime(int client, const char *id, int mode, int delay, qboolean voiceonly, int idleTime,
        qboolean forceIfDead);
...
extern int      BotNumTeamMatesWithTargetAndCloser(bot_state_t *bs, int targetEntity, int targetArea, int *list, int maxList,
        int playerType);
...
extern void     BotAI_Trace(bsp_trace_t *bsptrace, vec3_t start, vec3_t mins, vec3_t maxs, vec3_t end, int passent,
                            int contentmask);
...
extern void     BotUpdateAlertStateSquadSensingInfo(bot_state_t *bs, qboolean canSeeTarget, qboolean heardFootSteps,
